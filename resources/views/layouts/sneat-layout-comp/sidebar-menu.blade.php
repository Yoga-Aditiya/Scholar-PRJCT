...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a class="menu-link" href="{{route('admin.master-data.faculty')}}">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Fakultas</div>
            </a>
        </li>
        <li class="menu-item">
            <a class="menu-link" href="{{route('admin.master-data.faculty-adm')}}">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Admin Fakultas</div>
            </a>
        </li>
        @endhasanyrole
        @hasanyrole([App\Enum\RolesEnum::SYS_ADMIN, App\Enum\RolesEnum::FACULTY_ADMIN])
        <li class="menu-item">
            <a class="menu-link" href="{{route('admin.master-data.study-program')}}">
                <i class="menu-icon tf-icons bx bx-table"></i>
        ...
        @hasanyrole([App\Enum\RolesEnum::SYS_ADMIN, App\Enum\RolesEnum::FACULTY_ADMIN])
        <li class="menu-item">
            <a class="menu-link" href="{{route('admin.master-data.study-program-adm')}}">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Admin Program Studi</div>
            </a>
        </li>
        @endhasanyrole
        @hasanyrole([App\Enum\RolesEnum::SYS_ADMIN, App\Enum\RolesEnum::FACULTY_ADMIN,
        App\Enum\RolesEnum::STUDY_PROGRAM_ADMIN])
        <li class="menu-item">
            <a class="menu-link" href="{{route('admin.master-data.lecturer')}}">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Dosen</div>
            </a>
        </li>
        @endhasanyrole
        @hasanyrole([App\Enum\RolesEnum::SYS_ADMIN, App\Enum\RolesEnum::FACULTY_ADMIN,
        ...
        <li class="menu-item" style="">
            <a class="menu-link" href="{{route('admin.setting.system-setting')}}">
                <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                <div data-i18n="Misc">System Settings</div>
            </a>
        </li>
        @endhasanyrole
    </ul>
