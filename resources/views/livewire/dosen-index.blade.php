            ...
            <table class="table">
                ...
                @foreach($dosens as $item)
                    @if ($item->lecturer)
                        <tr>
                            <td>
                                {{$item->lecturer->front_title}} {{$item->name}} {{$item->lecturer->back_title}}
                            </td>
                            <td>
                                {{$item->email}}
                            </td>
                            <td>
                                <a href="https://www.scopus.com/authid/detail.uri?authorId={{$item->lecturer->scopus_id}}"
                                   target="_blank">{{$item->lecturer->scopus_id}}</a></td>
                            <td>
                                <a href="https://scholar.google.com/citations?hl=en&user={{$item->lecturer->scholar_id}}"
                                   target="_blank">{{$item->lecturer->scholar_id}}</a></td>
                            <td>
